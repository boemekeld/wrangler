...
pub fn sync(
    ...
    let (diff_files_to_upload, mut asset_manifest, _): (Vec<KeyValuePair>, AssetManifest, _) =
    ...
    let to_upload = filter_files(diff_files_to_upload.clone(), &remote_subset, &subset_str);
